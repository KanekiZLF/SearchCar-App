  ...
  return (
    <>
      ...
      <div className="car-container">
        {/* Wrapper para conteúdo principal lado a lado */}
        <div className="car-main">
          ...
          <div className="car-content">
            ...
            <div className="car-items">
              ...
              <div className="car-items-grid">
                {carro.items &&
                  Object.values(carro.items).map((item, index) => (
          ...
          <div className="car-contact">
            <h2>
              R{"$ "}
              {(carro.preco ?? 0).toLocaleString("pt-BR", {
                style: "currency",
                currency: "BRL",
              })}
            </h2>
        ...
        <div className="car-values">
          ...
          <div>
            ...
            <h2>
              R{"$ "}
              {(carro.avaliacao ?? 0).toLocaleString("pt-BR", {
                style: "currency",
                currency: "BRL",
              })}
            </h2>
          ...
          <div>
            ...
            <h2>
              R{"$ "}
              {(carro.fipe ?? 0).toLocaleString("pt-BR", {
                style: "currency",
                currency: "BRL",
              })}
            </h2>
